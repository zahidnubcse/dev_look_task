...
export default function Practice() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (progress < 400) setActiveIndex(0);
      else if (progress < 1000) setActiveIndex(1);
  ...
  return (
    <div ref={sectionRef} className="relative h-[260vh] px-2 md:px-4">

      {/* Sticky Section */}
      <div className="sticky top-0 h-screen flex items-center">

        <div className="relative w-full lg:h-[700px] sm:h-[750px] bg-black rounded-[40px] px-6 md:px-10 overflow-hidden flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="relative z-10 w-full md:w-[56%] flex justify-end">
            ...
            <AnimatePresence mode="wait">
              ...
              <motion.div
                ...
                className="relative w-full md:w-[850px] group"
              >
                ...
                <div className="relative overflow-hidden rounded-[30px]">
                  ...
                  <motion.div
                    ...
                    className="absolute inset-0 flex items-center justify-center text-center px-6 opacity-0 group-hover:opacity-100 transition-all duration-500"
                  >
                    <p className="text-white text-lg md:text-2xl font-medium leading-snug">
                      {projects[activeIndex].title} — crafted with precision and modern UX thinking
                    </p>
                  </motion.div>
                ...
                {/* TAG */}
                <div className="absolute bottom-5 right-5 z-30 flex items-center gap-3 backdrop-blur-xl bg-white/10 border border-white/20 rounded-full px-5 py-3">
